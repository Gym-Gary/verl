...
class NPUToolConfig(NsightToolConfig):
    ...
    # Optional values: all, actor_compute_log_prob, actor_update, critic_compute_values, critic_update, 
    #                  ref_compute_log_prob, rollout_generate, reward_compute_rm_score
    # "all" means all stages will ve profiled.
    ...
    def __post_init__(self) -> None:
        ...
        assert isinstance(self.stages, list), f"Profiler discrete must be of type list, got {type(self.stages)}"
        ...
        for stage in self.stages:
            assert stage in ["all", "actor_compute_log_prob", "actor_update", "critic_compute_values", "critic_update",
                             "ref_compute_log_prob", "rollout_generate", "reward_compute_rm_score"], (
                "Profiler stages only supports all, actor_compute_log_prob, actor_update, critic_compute_values, "
                f"critic_update, ref_compute_log_prob, rollout_generate, reward_compute_rm_score, but gets {stage}"
            )
